...
public class PhysicsSim {
     ...
     *        The maximum motor velocity, in ticks per 100ms
     */
    public void addTalonFX(WPI_TalonFX falcon, final double accelToFullTime, final double fullVel) {
     ...
     */
    public void addTalonFX(WPI_TalonFX falcon, final double accelToFullTime, final double fullVel, final boolean sensorPhase) {
        if (falcon != null) {
