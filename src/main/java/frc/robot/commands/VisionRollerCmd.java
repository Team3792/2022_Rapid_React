...
public class VisionRollerCmd extends CommandBase{
  ...
  public VisionRollerCmd(RollerSubsystem roller, boolean vision, boolean preSpin) {
      this.roller = roller;
      this.vision = vision;
  ...
  public void execute() 
  {
    ...
    roller.setRoller(roller.getRollerRPM());
